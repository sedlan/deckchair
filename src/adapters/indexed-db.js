...
deckchair.adapter('indexed-db', (function(){

	function fail(e, i) {
		console.log('error in indexed-db adapter!', e, i);
		throw 'error in indexed-db adapter!';
	}
	...
	return {
		...
		save: function(obj, callback) {
			...
			// Removed last parameter - used to get "Type error", now it's ok
			...
			if (obj.key) {
				var request = store.put(obj, obj.key);
			} else {
